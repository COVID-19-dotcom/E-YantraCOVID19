...
class RegsterUser : AppCompatActivity() {
                                            ...
                                            if(validateOpMobile()){
                                                ...
                                                if(validatePass()){
                                                    ...
                                                    if(isConnected()) {
                                                        ...
                                                        Toast.makeText(applicationContext,"No Internet Connection,Try Again!",Toast.LENGTH_LONG).show()
                                                    }
                                                }else{
    ...
    private fun isConnected() : Boolean{
        val connMrg = getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
        val netInfo = connMrg.activeNetworkInfo

...
class UserResult : AppCompatActivity() {
    ...
    fun sendSMS()
    {
        ...
        var drname=intentkey1.getStringExtra("drname")
        var username=pref.getString("username",null)
        var num=key2
        val messageToSend = "Dr. $drname,\n " +
                "Your Patient with name $username need some Advice regarding COVID-19." +
                "Please Make him/her Call for the same."+
                "Don't Replay here..."
